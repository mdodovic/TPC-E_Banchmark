...
public class NormalizedChema {
	...
	public static void createNormalizedDatabaseChema(Connection conn) {
		...
		try {
			...
			System.out.println(createChemaQuery);
			

			
			Statement stmt;
			stmt = conn.createStatement();
			int rs = stmt.executeUpdate(createChemaQuery);
	...
	private static void dropNormalizedDatabaseChema(Connection conn) throws SQLException  {
